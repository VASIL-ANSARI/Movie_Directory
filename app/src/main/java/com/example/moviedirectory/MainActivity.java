...
public class MainActivity extends AppCompatActivity {
    ...
    private MobileRecyclerViewAdapter mobileRecyclerViewAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mobileRecyclerViewAdapter=new MobileRecyclerViewAdapter(this,movieList);
        recyclerView.setAdapter(mobileRecyclerViewAdapter);
        mobileRecyclerViewAdapter.notifyDataSetChanged();
    }
            ...
            public void onClick(View v) {
                ...
                if (!newSearchEdt.getText().toString().isEmpty()) {
                   ...
                   // getMovies(search);
                    ...
                    mobileRecyclerViewAdapter.notifyDataSetChanged();//Very important!!
                }
                dialog.dismiss();
        ...
        JsonObjectRequest jsonObjectRequest=new JsonObjectRequest(Request.Method.GET,
            ...
            public void onResponse(JSONObject response) {
                ...
                try{
                     ...
                     */
                    mobileRecyclerViewAdapter.notifyDataSetChanged();//Important!!
